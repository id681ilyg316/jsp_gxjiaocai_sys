...
<link rel="stylesheet" href="images/hsgcommon/div.css" type="text/css">
  ...
  <form name="form1" id="form1" action="">
   搜索:  订单号：<input name="dingdanhao" type="text" id="dingdanhao" class="form-control2" />  书号：<input name="shuhao" type="text" id="shuhao" class="form-control2" />
   <input type="submit" name="Submit" value="查找" class="btn btn-info btn-small" /> <input type="button" name="Submit2" value="导出EXCEL" class="btn btn-info btn-small" onClick="javascript:location.href='jiaocaidinggou_listxls.jsp';" />
</form>
...
if(request.getParameter("caigouren")=="" ||request.getParameter("caigouren")==null ){}else{sql=sql+" and caigouren like '%"+request.getParameter("caigouren")+"%'";}
  ...
  <tr>
    ...
    <td width="220" align="center"><a class="btn btn-info btn-small" href="jiaocaidinggou_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a class="btn btn-info btn-small" href="jiaocaidinggou_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a class="btn btn-info btn-small" href="jiaocaidinggou_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
