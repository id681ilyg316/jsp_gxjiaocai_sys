...
function gow()
{
	document.location.href="jiaocaichuku_add.jsp?id=<%=id%>";
}
...
new CommDAO().insert(request,response,"jiaocaichuku",ext,true,false,""); 
