...
new CommDAO().update(request,response,"jiaocairuku",ext,true,false,""); 
HashMap mmm = new CommDAO().getmap(id,"jiaocairuku"); 

%>
  <form  action="jiaocairuku_updt.jsp?f=f&id=<%=mmm.get("id")%>"  name="form1"  onsubmit="return checkform();">
  修改教材入库:
  <br><br>
 
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#cccccc" style="border-collapse:collapse">  
     
     <tr><td>入库编号：</td><td><input name='rukubianhao' type='text' id='rukubianhao' value='<%= mmm.get("rukubianhao")%>' class="form-control" /></td></tr>
     <tr><td>书名：</td><td><input name='shuming' type='text' id='shuming' value='<%= mmm.get("shuming")%>' class="form-control" /></td></tr>
     ...
     <tr><td>入库时间：</td><td><input name='rukushijian' type='text' id='rukushijian' value='<%= mmm.get("rukushijian")%>' onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" readonly='readonly' class="form-control"  /></td></tr>
