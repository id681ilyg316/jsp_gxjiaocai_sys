...
if(request.getParameter("jiaocaimingcheng")=="" ||request.getParameter("jiaocaimingcheng")==null ){}else{sql=sql+" and jiaocaimingcheng like '%"+request.getParameter("jiaocaimingcheng")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a class="btn btn-info btn-small" href='jiaocaidinggou_add.jsp?id=<%=map.get("id")%>'>添加教材订购</a> <a class="btn btn-info btn-small" href="jiaocaixinxidetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
