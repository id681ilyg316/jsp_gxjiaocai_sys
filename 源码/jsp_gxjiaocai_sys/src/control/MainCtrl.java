	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("login"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				if(utype.equals("教师")){sql1 = "select * from jiaoshixinxi where xuegonghao='"+username+"' and mima='"+password+"' ";}if(utype.equals("学生")){sql1 = "select * from xueshengxinxi where xuehao='"+username+"' and mima='"+password+"' ";}
